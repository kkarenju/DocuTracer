<div class="document work">
    ...
    <div class="block">
        <div class="doc">
            ...
            <br>
            <input type="text" name="fname10" value="<?php echo $f10; ?>">
        </div>
        
        <div class="doc">
            <label class="profile-title">Surname:</label>
            <br>
            <input type="text" name="sname10" value="<?php echo $s10; ?>">
        </div>
    ...
    <div class="doc1">
        ...
        <br>
        <textarea name="details11" rows="7" title="details" maxlength="1050" placeholder="Found document details (1050 characters max)..."><?php echo $details11;?></textarea>
    </div>
