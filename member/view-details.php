<div class="boxes-full view-details">
            <div id="portfolio-container">
                ...
                <div class="element web">
                    <div class="portfoliowrap">
                        <?php $id =$row1['DID']; ?>
                        <div>      
                            <input name="checkbox[]" type="checkbox" id="checkbox[]" style="float:left" value="<?php echo $id; ?> ">
                      ...
                      <div class="text">
                          ...
                          <br>
                          <label class="details-title">Registered:</label> 
                          <label class="personal-info"> <?php echo date_format(date_create($row1['date_registered']),"d M, Y"); ?> </label>
                          <br>
                          <label class="details-title">Status:</label> 
                          <label class="personal-info"> <?php echo $row1['status']; ?> </label>
                          <br>
                          <?php 
                            if($row1['status']=="Lost"){
                          ?>
                            <label class="details-title">Reported:</label> 
                            <label class="personal-info"> <?php echo date_format(date_create($row1['date_reported'])," D, d M, Y"); ?> </label>
                          <?php }else{ ?>
